...
ActiveRecord::Schema[7.0].define(version: 2023_09_22_133108) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "account_activity_taggings", force: :cascade do |t|
    t.bigint "activity_tag_id", null: false
    t.bigint "account_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_account_activity_taggings_on_account_id"
    t.index ["activity_tag_id"], name: "index_account_activity_taggings_on_activity_tag_id"
  end
  ...
  create_table "account_rating_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_account_rating_details_on_account_id"
  end
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.string "linkedin_social"
    t.string "facebook_social"
    t.string "x_social"
  ...
  create_table "operating_locations", force: :cascade do |t|
    t.integer "position"
    t.string "address"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_operating_locations_on_account_id"
  end
  ...
  add_foreign_key "account_activity_taggings", "accounts"
  add_foreign_key "account_activity_taggings", "activity_tags"
  ...
  add_foreign_key "operating_locations", "accounts"
